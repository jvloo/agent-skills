---
name: use-codex
description: Consult or delegate a bounded task to the local Codex CLI for reviews, second opinions, implementation, or supervised sessions. Use when the user or active workflow requests that CLI worker. Reviewing or installing this skill does not request a model call; browser UI work and ordinary host subagents are separate.
---
