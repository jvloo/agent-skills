---
name: use-claude
description: Use when a user or workflow requests Claude Code as a local CLI worker for a second opinion, code review, implementation, or session continuation. Delegates bounded work and verifies the returned result.
metadata:
  version: "0.2.1"
---
